...
public Action:Timer_MapStart(Handle:Timer)
{
	...
	CreateTimer(1.0, Timer_WaveSpawning,_ , TIMER_REPEAT | TIMER_FLAG_NO_MAPCHANGE);*/ // function did nothing
...
public Action:RespawnBot(Handle:Timer, any:client)
{
	...
	if (client <= 0 || client > MaxClients || !IsClientInGame(client) || IsPlayerAlive(client) || g_iRoundStatus == 0)
	{
		return;
	}
