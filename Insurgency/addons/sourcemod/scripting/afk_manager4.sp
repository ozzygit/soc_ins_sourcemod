...
void RegisterCvars() // Cvar Registrations
{
	...
	hCvarLogDays = CreateConVar("sm_afk_log_days", "60", "How many days should we keep AFK Manager log files. [0 = INFINITE, DEFAULT: 0]");
	...
	hCvarMinPlayersKick = CreateConVar("sm_afk_kick_min_players", "8", "Minimum number of connected clients required for AFK kick to be enabled. [DEFAULT: 6]");
	...
	hCvarTimeToMove = CreateConVar("sm_afk_move_time", "180.0", "Time in seconds (total) client must be AFK before being moved to spectator. [0 = DISABLED, DEFAULT: 60.0 seconds]");
	...
	hCvarTimeToKick = CreateConVar("sm_afk_kick_time", "600.0", "Time in seconds (total) client must be AFK before being kicked. [0 = DISABLED, DEFAULT: 120.0 seconds]");
	...
	hCvarSpawnTime = CreateConVar("sm_afk_spawn_time", "90.0", "Time in seconds (total) that player should have moved from their spawn position. [0 = DISABLED, DEFAULT: 20.0 seconds]");
	hCvarWarnSpawnTime = CreateConVar("sm_afk_spawn_warn_time", "30.0", "Time in seconds remaining, player should be warned for being AFK in spawn. [DEFAULT: 15.0 seconds]");
