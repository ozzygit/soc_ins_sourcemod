...
SetupDefaultMessages()
{
	...
	{				
		...
		KvSetString(hKVCountryShow, "playerjoin", "{PLAYERTYPE} {GREEN}{PLAYERNAME} {DEFAULT} connected from country {DEFAULT} {GREEN}{PLAYERCOUNTRY}");
		KvSetString(hKVCountryShow, "playerdisc", "{PLAYERTYPE} {GREEN}{PLAYERNAME} {DEFAULT} from country {DEFAULT} {GREEN}{PLAYERCOUNTRY} {DEFAULT} disconnected");
