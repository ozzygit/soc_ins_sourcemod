...
public void OnPluginStart() {
	...
	gCvarRound = CreateConVar("sm_firesupport_shell_num", "6.0", "Shells to fire.", FCVAR_PROTECTED, true, 1.0);
	gCvarDelay = CreateConVar("sm_firesupport_delay", "12.0", "Min delay to first shell.", FCVAR_PROTECTED, true, 1.0);
	gCvarDelayNextSupport = CreateConVar("sm_firesupport_delay_support", "60.0", "Min delay to next support.", FCVAR_PROTECTED, true, 1.0);
	gCvarClass = CreateConVar("sm_firesupport_class", "template_combat_medic", "Set fire support specialist class.", FCVAR_PROTECTED);
	gCvarCountPerRound = CreateConVar("sm_firesupport_count", "0", "Count of available support per rounds(0 = disable)", FCVAR_PROTECTED, true, 0.0);
	gCvarEnableCmd = CreateConVar("sm_firesupport_enable_cmd", "1", "Player can call fire support using sm_firesupport_call.", FCVAR_PROTECTED);
	...
	RegConsoleCmd("sm_firesupport_call", CmdCallFS, "Call fire support where you looking at.", 1);
	RegAdminCmd("sm_firesupport_ad_call", CmdCallAFS, 1);										// HINT: test command
